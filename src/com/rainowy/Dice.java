...
public class Dice {
    ...
    private static final com.rainowy.User firstUser = new com.rainowy.User("Pierwszy gracz", 0);
    private static final com.rainowy.User secondUser = new com.rainowy.User("Drugi gracz", 0);
